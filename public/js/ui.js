...
const updateUI = async () => {
  try {
    ...
    if (isAuthenticated) {
      ...
      const order_history_data = await orderHistoryPizza();
      document.getElementById("history-data").innerText =JSON.stringify(
        order_history_data,
        null,
        2
      ); 
      ...
      if (!user.email_verified) {
        ...
        document.getElementById("verify-email").classList.add("hidden");
    ...
    document.getElementById("checkout-btn").disabled = !isAuthenticated;
